...
@Module({ imports: [ScheduleModule.forRoot(), EventEmitterModule.forRoot(), PrismaModule, DebtsModule, MoneyModule, AccountingModule, BudgetModule, GoalsModule, InvestmentsModule, ProjectionModule] })
