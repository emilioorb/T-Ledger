  ...
  return (
    <section className="space-y-6">
      ...
      {loading ? (
        ...
        <>
          {/* Las cuatro cifras que contestan «cómo estoy»: cuánto tengo, cuánto ahorré este
              mes, cuánto debo y cuánto está rindiendo. Lo que queda libre no está acá: el
              gráfico de abajo dice eso mismo, mes a mes y con más contexto.

              Cuatro tarjetas se reparten en cuatro, en dos y dos, o apiladas: ninguna de las
              tres formas deja una sola abajo. Sin `col-span` en la primera: el patrimonio ya
              se distingue por la cifra más grande, y a lo ancho quedaba del doble que sus
              vecinas sin que eso dijera nada. */}
          <StatGrid className="grid-cols-1 @xl:grid-cols-2 @5xl:grid-cols-4">
            <StatCard
              icon={Landmark}
