...
export type DebtSchedule = components['schemas']['DebtSchedule']
export type DebtInstallment = components['schemas']['DebtInstallment']
export type PagarCuotaInput = components['schemas']['PagarCuotaInput']
