...
export const copy = {
  ...
  intro: {
    title: 'Soy Nimbo',
    nimbo:
      'Te ayudo a dejar el libro listo en **seis pasos**: tus monedas, tus bancos, lo que tenés hoy, en qué gastás, cuánto entra este mes y un resumen al final. Cualquiera se puede *saltar*.',
  },
  monedas: {
    title: 'Monedas',
  ...
  bancos: {
    ...
    sugeridos: ['BN', 'BCR', 'BAC Credomatic', 'Banco Popular', 'Davivienda', 'Promerica'],
    otro: 'Otro banco',
