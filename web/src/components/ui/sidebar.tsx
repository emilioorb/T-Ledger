...
function Sidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* El hueco que la barra le deja al contenido en escritorio. Sin transición: la barra
          se alterna con Cmd/Ctrl+B decenas de veces al día, y animar `width` recalcula el
          layout de toda la página en cada frame para algo que nadie mira. */}
      <div
