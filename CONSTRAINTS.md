...
| E3 | Aserción cambiada (1, guardia del piso) | `api`: `shared/prisma/clasificacion-de-modelos.spec.ts` | Reescrita, no perdida: la bienvenida suma `OnboardingStep`, un modelo con `bookId`, y el conteo de modelos del libro sube 20→21; el test sigue exigiendo el número exacto. Aserciones: 6→6. Aceptada por Emilio el 2026-09-25. Deja de aplicar cuando la rama entre a `main`. | Emilio | 2026-10-09 |
